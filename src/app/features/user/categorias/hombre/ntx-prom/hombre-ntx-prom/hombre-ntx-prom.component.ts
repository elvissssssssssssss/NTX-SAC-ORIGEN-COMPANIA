...
@Component({
  selector: 'app-hombre-ntx-prom',
    standalone: true,
  imports: [CommonModule, RouterModule, FormsModule],
  templateUrl: './hombre-ntx-prom.component.html',
  styleUrl: './hombre-ntx-prom.component.css'
})
export class HombreNtxPromcomponent implements OnInit {
    productos: Product[] = [];
...
ngOnInit(): void {
  ...
  cargarProductos(): void {
    this.productoService.getProductosPorCategoria('hombre_ntx_prom').subscribe({ //aqui los 3 tienen que estar igual en create ts y edit ts
      next: res => {
